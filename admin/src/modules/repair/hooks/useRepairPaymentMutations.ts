...
export function useCreateRepairPayment(): UseMutationResult<PaymentResponse, unknown, CreatePaymentRequest> {
  ...
  return useMutation({
    ...
    onSuccess: (_data, request) => {
      ...
      if (request.referenceType === REFERENCE_TYPES.REPAIR) {
        void queryClient.invalidateQueries({ queryKey: ['repairs', 'detail', request.referenceId] });
      }
